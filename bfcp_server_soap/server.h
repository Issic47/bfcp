...
//gsoap ns service namespace: http://localhost:9000/BFCPService.wsdl
//gsoap ns service location:  http://localhost:9000/BFCPService.cgi

//gsoap ns schema namespace:	urn:BFCPService

#import "stlvector.h"

class ns__ConferenceList
{
public:
...
int ns__removeConference(unsigned int conferenceID, void);
...
int ns__getConferenceIDs(ns__ConferenceList *result);
